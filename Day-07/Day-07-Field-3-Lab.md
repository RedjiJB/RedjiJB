# Day 07  Field 3 (DePIN): Switching Basics with Byzantine Failure Simulation
...
Relationship to Base Lab: Same VLAN topology as base Day-07, but adds Byzantine failure injection and measures flooding reliability.
Prerequisite: Complete Day-07-Lab-Manual first.
...
Same as base Day-07 VLAN topology + Byzantine failure injection on SW1 (drop 5% random packets).
