# Day 03 — Field 1 (Black Start): Network Cabling for Offline Resilience
...
**BASE TOPOLOGY (Day-03-Lab-Manual):**
```
R1 ← [Fiber 3km] ← R3
...
**Same as base Day-03, but with secondary IP addresses on backup copper links:**
