# Day 03 — Field 3 (DePIN): Switching Basics with Byzantine Failure Simulation
...
Relationship to Base Lab: Same VLAN topology as base Day-03, but adds Byzantine failure injection and measures flooding reliability.
Prerequisite: Complete Day-03-Lab-Manual first.
...
Same as base Day-03 VLAN topology + Byzantine failure injection on SW1 (drop 5% random packets).
