# Day 04  Field 3 (DePIN): Switching Basics with Byzantine Failure Simulation
...
Relationship to Base Lab: Same VLAN topology as base Day-04, but adds Byzantine failure injection and measures flooding reliability.
...
Same as base Day-04 VLAN topology + Byzantine failure injection on SW1 (drop 5% random packets).
