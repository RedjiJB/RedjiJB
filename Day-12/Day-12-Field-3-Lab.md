# Day 12 — Field 3 (DePIN): VLANs with Distributed Consensus
...
Prerequisite: Complete Day-12-Lab-Manual first.
...
## 2. Topology Diagram
Same as base Day-12 (SW1 ↔ SW2 ↔ SW3 with VLANs).
