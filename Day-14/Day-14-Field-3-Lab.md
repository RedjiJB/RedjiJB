# Day 14 — Field 3 (DePIN): VLANs with Distributed Consensus
...
Prerequisite: Complete Day-14-Lab-Manual first.
...
## 2. Topology Diagram
Same as base Day-14 (SW1 ↔ SW2 ↔ SW3 with VLANs).
