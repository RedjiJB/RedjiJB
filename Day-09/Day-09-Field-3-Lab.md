# Day 09 — Field 3 (DePIN): VLANs with Distributed Consensus
...
Prerequisite: Complete Day-09-Lab-Manual first.
...
## 2. Topology Diagram
Same as base Day-09 (SW1 ↔ SW2 ↔ SW3 with VLANs).
