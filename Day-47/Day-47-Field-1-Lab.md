# Day 47 Field-1 Variant — QoS Offline Resilience & DSCP Persistence
...
Prerequisite:        Complete Day-47-Lab-Manual first.
```
...
Same as base Day-47 (192.168.0.0/24 PC, 10.0.0.0/24 server), with annotation that this topology **must work identically after cold reboot**.
