# Day 13 — Field 3 (DePIN): VLANs with Distributed Consensus
...
Prerequisite: Complete Day-13-Lab-Manual first.
...
## 2. Topology Diagram
Same as base Day-13 (SW1 ↔ SW2 ↔ SW3 with VLANs).
