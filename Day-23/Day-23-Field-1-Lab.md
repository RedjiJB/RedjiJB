# Day 23 — Floating Static Routes and Failover Testing
...
In P38, some hotspots will be solar-powered and battery-backed, running 24/7 on intermittent charging. Running OSPF 24/7 drains battery; running it on a schedule (e.g., 8 AM–6 PM) saves power. Day-23-Field-1 proves this is feasible: static routes with floating backups provide automatic failover without OSPF.
...
- Day-23-Research-Paper.md (Section 2.6: Field-1 linkage)
